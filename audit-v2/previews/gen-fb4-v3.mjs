...
const PS15 = {
  ...
  // Правка по вердикту 2026-07-25: первая руина была примитивна и не опознавалась.
  // Теперь она ЦИТИРУЕТ башню — те же двойные стены со щелью и тот же цоколь, но
  // верх срезан, перемычка сорвана и свисает влево, справа рухнувший блок, у
  // подножия щебень. Уровень «нет» перестал быть просто отсутствием знака.
  none: `<svg viewBox="0 0 15 15" fill="currentColor">`
    + `<rect x="4" y="5" width="3" height="1" opacity="0.85"/>`
    + `<path d="M5 12V6H6V8H7V12Z"/>`
    + `<path d="M8 12V10H9V9H10V12Z"/>`
    + `<rect x="10" y="10" width="2" height="2" opacity="0.7"/>`
