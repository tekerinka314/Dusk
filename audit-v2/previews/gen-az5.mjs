...
// старт — у самого конца пасти (в глотке), в щели между сходящимся хвостом
// (сверху) и верхней кромкой нижней челюсти (снизу)
const TONGUE = `<path d="M14.25 5.3 C13.6 5.75 12.7 6.15 11.6 6.45 C10.6 6.72 9.8 6.85 9.15 6.95 C8.5 7.5 8.05 8.4 8.05 9.25" stroke-width="0.55"/>` +
