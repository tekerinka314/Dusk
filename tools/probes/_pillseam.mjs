...
const box = await p.evaluate(() => {
  ...
  return { x: b1.right - 26, y: b1.top - 6, width: (b2.right - b1.right) + 34, height: b1.height + 12 };
});
await p.screenshot({ path: 'D:/VSCode projects/DUSK_v2.0/audit-v2/shots/_pillseam.png', clip: box });
