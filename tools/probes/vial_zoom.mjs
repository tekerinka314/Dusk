...
const CASES = [
  ['icon-vial-none', 12, '0 0 24 24', 'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"'],
  ['icon-vial-none', 14, '0 0 24 24', 'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"'],
  ['icon-swords', 12, '0 0 24 24', 'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"'],
];
...
await page.screenshot({ path: 'D:/VSCode projects/DUSK_v2.0/audit-v2/shots/icon-sheet/rev/vial_zoom.png' });
console.log('ок');
await browser.close();
